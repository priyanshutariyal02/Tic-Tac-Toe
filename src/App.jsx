...
function deriveGameBoard(gameTurns) {
  // let gameBoard = initialGameBoard; bug

  let gameBoard = [...INITIAL_GAME_BOARD.map((array) => [...array])]; // creating the copy of initial array to fix bug & it must be a deep copy
